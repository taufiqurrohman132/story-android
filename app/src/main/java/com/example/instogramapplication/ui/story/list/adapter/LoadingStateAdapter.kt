...
class LoadingStateAdapter(private val retry: () -> Unit) :
    ...
    inner class LoadingStateViewHolder(private val binding: ItemLoadingStoryYBinding) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemLoadingStoryYBinding.inflate(LayoutInflater.from(parent.context), parent, false)
